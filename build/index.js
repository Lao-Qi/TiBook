...
const buildMain = require("./app-main-build")
const buildRender = require("./app-render-build")
const buildElectron = require("./app-electron-build")
...
if (process.argv.length > 2) {
    ...
    ;(async function () {
        ...
        await build_operates.main_build()
        await build_operates.render_build()
        build_operates.cp_public()
        build_operates.generate_package()
        await build_operates.electron_build()
    })()
}
