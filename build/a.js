...
//         files: ["./dist/app-render/**/*", "./dist/app-main/**/*"], // 软件打包资源文件
//         directories: {
//             output: "./app-dist" // 软件打包后输出的文件夹
//         },
//         dmg: {
//             // dmg macOS系统上的安装包格式
//             window: {
...
//             installerIcon: "./dist/public/icon-256x256.ico", // 软件图标
//             installerHeaderIcon: "./dist/public/icon-256x256.ico", // 安装程序的标题图标
//             uninstallerIcon: "./dist/public/icon-uninstall-256x256.ico", // 卸载软件程序的图标
...
//         win: {
//             // windows系统配置
//             icon: "./dist/public/icon-256x256.ico", // 软件图标
//             target: [
//                 {
...
//         mac: {
//             // macOS系统配置
//             icon: "./dist/public/icns-256x256.icns", // 软件图标
//             target: "dmg" // 打包驱动
//         },
//         linux: {
//             // linux系统配置
