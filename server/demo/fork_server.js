...
// 		}
//
// 		socket.emit("own message", strMsg);
...
//
// 		// 通知
// 		socket.emit("join room message", {code: 200, account});
...
// 		}else {
// 			socket.emit("connect-msg", "token认证失败，请重新登录");
// 			socket.disconnect(true);
// 		}
// 	}else {
// 		socket.emit("connect-msg", "token已过期，请重新登录");
// 		socket.disconnect(true);
// 	}
// }
//
